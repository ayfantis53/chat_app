...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatRoomId = getIntent().getStringExtra("img_of_roommate");
        ...
        Glide.with(MessageActivity.this).load(getIntent().getStringExtra("img_of_roommate")).placeholder(R.drawable.ic_account_img).error(R.drawable.ic_account_img).into(imgToolbar);
    }
